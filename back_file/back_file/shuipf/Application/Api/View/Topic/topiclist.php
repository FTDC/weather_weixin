...
<title><?php echo $catename; ?>专题列表</title>
<link rel="stylesheet"
	href="{$config_siteurl}/statics/assets/css/amazeui.css">
<style>
html, body, .page {
	height: 100%;
}
...
#wrapper {
	/*position: absolute;	top: 49px;	overflow: hidden;*/
	bottom: 0;
	margin: 0;
	width: 100%;
	padding: 0 8px;
...
<body>
	<div class="page">
        ...
        <li class="am-list-item-desced" data-id="<?php echo $val['id'];?>">
          <a href="<?php echo U('Api/Topic/detail',array('catid'=>$val['catid'], 'id'=>$val['id']))?>" class="am-list-item-hd" target="_blank"><?php echo $val['title'];?></a>
					</li>
         <?php }}else{?>
        ...
        <?php }?>
				...
				<div class="pull-action" id="pull-up" style="display: none;" >
	...
	<script src="{$config_siteurl}/statics/assets/js/handlebars.min.js"></script>
