    ...
    <div class="col-right">
        <div class="table_full">
            <table width="100%">
                ...
                if (is_array($forminfos['senior'])) {
                    foreach ($forminfos['senior'] as $field => $info) {
                        ...
                        ?>
                        <tr>
                            <td><b><?php echo $info['name'] ?></b><?php if ($info['star']) { ?><font
                                    color="red">*</font><?php } ?></td>
                        </tr>
                        <tr>
          ...
          <span class="switch_list cc">
			<label><input type="radio" name="info[status]" value="99"
                <if condition=" $data['status']==99 "> checked</if>
                ><span>审核通过</span></label>
			<label><input type="radio" name="info[status]" value="1"
                <if condition=" $data['status']==1 "> checked</if>
                ><span>待审核</span></label>
		 </span></td>
                </tr>
            </table>
                ...
                if (is_array($forminfos['base'])) {
                    foreach ($forminfos['base'] as $field => $info) {
                        ...
                        <tr>
                            ...
                            <td><?php if ($info['star']) { ?><span
                                    class="must_red">*</span><?php } ?><?php echo $info['form']; ?>
                                <span><?php echo $info['tips']; ?></span></td>
                        </tr>
                    <?php
                    }
                }
