...
<div class="wrap J_check_wrap">
    ...
    <div class="clearfix">
        <ul class="fl lsList_ul">
            <li>
                <span><em>*</em>关键词</span>
                <input name="keyword" type="text" value="{$data.keyword}" class="listText" />
            </li>
            ...
            <li>
                <span>优惠券数量 （0表示不限制数量） </i></span>
                <input name="num" type="text" value="{$data.num}" class="listText_02" />
            </li>
            ...
            <li>
                ...
                <input name="max_num" type="text" value="{$data.max_num}" class="listText_02" />
            </li>
            
             <li>
                <span>积分限制<i>(粉丝达到多少积分后才能领取，领取后不扣积分)</i></span>
                <input name="credit_conditon" type="text" value="{$data.credit_conditon}" class="listText_02" />
            </li>
            
            <li>
                <span>积分消费<i>(用积分中的财富兑换、兑换后扣除相应的积分财富)</i></span>
                <input name="credit_bug" type="text" value="{$data.credit_bug}" class="listText_02" />
            </li>
            
            <li>
                <span>插件场景限制<i>(格式：[插件名：id值],如[投票：10]表示对ID为10的投票投完才能领取,更多的说明见表单上的提示)</i></span>
                <input name="addon_condition" type="text" value="{$data.addon_condition}" class="listText" />
            </li>
