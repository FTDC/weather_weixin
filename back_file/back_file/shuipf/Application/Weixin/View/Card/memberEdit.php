...
<div class="wrap J_check_wrap">
    ...
    <div class="clearfix">
        <ul class="fl lsList_ul">
            ...
            <li>
                <span>姓名</span>
                <input name="username" type="text"  value="{$data.username}" class="listText_02" />
            </li>
            
            <li>
                <span>手机号</span>
                <input name="phone" type="text" value="{$data.phone}" class="listText_02" />
            </li>
            
             <li>
                <span>卡号</span>
                <input name="number" type="text" value="{$data.number}" class="listText_02" />
            </li>
