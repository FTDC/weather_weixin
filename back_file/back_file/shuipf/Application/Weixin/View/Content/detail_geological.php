...
<header class="am-g my-head">
    <div class="am-u-sm-12 am-article">
        <h1 class="am-article-title">气象地质灾害预警信息</h1>
    </div>
</header>
    ...
    <div class=" ">
        <div class="am-g">
            <div class="am-u-sm-11 am-u-sm-centered">
				<div class="am-cf am-article"><img width="100%" src="http://<?php echo $_SERVER['HTTP_HOST'] ;?>/weixin/weatherdata<?php echo  $info['img'];?>" title="" /></div>
                <div class="am-cf am-article"><?php echo  $info['content'];?></div>
                <div class="am-cf am-article">湖北省国土资源厅和湖北省气象局联合发布</div>
            </div>
        </div>
    </div>
