...
<div class="wrap J_check_wrap">
   <div class="zj_lqq">
	   <a href="{:U('CustomReplyText/add')}" target="mainContent"  class="btn">增加</a>
	      <a id="del" href="javascript:void(0);" target="mainContent"  class="btn">删除</a>
	   <div class="search-form fr cf">
	   		<form id="myform" class="J_ajaxForm" method="post" action="{:U(CustomReplyText/textlists)}">
			<div class="sleft">
   ...
   <form id="delform" class="J_ajaxForm" method="post" action="{:U('CustomReplyText/del')}">
            ...
            <tbody>
              <tr>
                  ...
                  <td><input class="checkbox" type="checkbox" value="{$vo.id}"></td>
                      ...
                      <td>{$vo.sort}</td>
                      <td>{$vo.view_count}</td>
                      <td><a target="_self" href="{:U('CustomReplyText/edit',array('id'=>$vo['id']))}">编辑</a> <a target="_self" href="{:U('CustomReplyText/del',array('id'=>$vo['id']))}">删除</a></td>
                  </tr><tr>
                  </foreach>
             </tr>            
          </tbody>
