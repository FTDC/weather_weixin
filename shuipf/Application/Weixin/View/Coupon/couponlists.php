...
<div class="wrap J_check_wrap">
   ...
   <div class="zj_lqq">
	   <a href="{:U('Coupon/add')}" >增加</a>
	   <a id="del" href="javascript:void(0);" >删除</a>
	   <div class="search-form fr cf">
	   		<form id="myform" class="J_ajaxForm" method="post" action="{:U(Coupon/couponlists)}">
			<div class="sleft">
  ...
  <form id="delform" class="J_ajaxForm" method="post" action="{:U('Coupon/del')}">
            ...
            <tbody>
              <tr>
                  ...
                  <td><input  class="checkbox" type="checkbox" value="{$vo.id}" name=""></td>
                      ...
                      <td>
                      	<a target="_self" href="{:U('Coupon/edit',array('id'=>$vo['id']))}">编辑</a>
                      	<a target="_self" href="{:U('Coupon/del',array('id'=>$vo['id']))}">删除</a>
                      	<a target="_self" href="{:U('Sn/snlists',array('id'=>$vo['id']))}">成员管理</a>
                      	<a target="black" href="{:U('Coupon/preview',array('id'=>$vo['id']))}">预览</a>
                      </td>
                  </tr><tr>
                  </foreach>
             </tr>            
