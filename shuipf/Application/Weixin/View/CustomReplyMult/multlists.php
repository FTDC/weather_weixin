...
<div class="wrap J_check_wrap">
   <Admintemplate file="Common/Nav"/>
    <div class="zj_lqq">
	   <a href="{:U('CustomReplyMult/add')}"  class="btn">增加</a>
	    <a id="del" href="javascript:void(0);"  class="btn">删除</a>
     	...
     	<thead>
            ...
            <tbody>
              <tr>
                  ...
                  <td>{$vo.news}</td>
                  <td><a target="_self" href="{:U('CustomReplyMult/edit',array('id'=>$vo['id']))}">编辑</a> <a target="_self" href="{:U('CustomReplyMult/del',array('id'=>$vo['id']))}">删除</a></td>
                  </tr><tr>
                  </foreach>
             </tr>            
          </tbody>
