  ...
  <table width="100%" height="100%" style="table-layout:fixed;">
    <tr class="head">
      ...
      <td><div class="nav"> 
        ...
        <div class="login_info"><span class="mr10">{$role_name}： {$userInfo.username}</span><a href="{:U('Public/logout')}" class="mr10">[注销]</a>{:tag("view_admin_top_menu")}<?php if(\Libs\System\RBAC::authenticate('Admin/Topic/cache')){ ?><a href="javascript:;;" id="deletecache" class="home"  style="color:#FFF">缓存更新</a><?php } ?></div></td>
    </tr>
    <tr class="tab">
      <th> <div class="search">
...
<literal>
<script>
<?php if(\Libs\System\RBAC::authenticate('Admin/Topic/cache')){ ?>
$("#deletecache").on('click',function(e){
    e.preventDefault();
    e.stopPropagation();
    iframeJudge({
        elem: $(this),
        href: "<?php echo U('Topic/cache')?>",
        id: "deletecache"
    });
});
<?php } ?>
...
//用于维持在线
function online(){
    $.get('<?php echo U("Admin/Topic/index");?>');
}
