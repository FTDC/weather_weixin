...
<header class="am-g my-head">
  <div class="am-u-sm-12 am-article">
    ...
    <p class="am-article-meta"><?php echo date('Y-m-d', $info['updatetime'])?></p>
  </div>
</header>
...
<script src="{$config_siteurl}/statics/assets/js/amazeui.ie8polyfill.min.js"></script>
<![endif]-->

<!--[if (gte IE 9)|!(IE)]><!-->
<script src="{$config_siteurl}/statics/assets/js/jquery.min.js"></script>
<!--<![endif]-->
<script src="{$config_siteurl}/statics/assets/js/amazeui.min.js"></script>
</body>
</html>
