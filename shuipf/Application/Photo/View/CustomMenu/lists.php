...
<div class="wrap J_check_wrap">
  ...
  <a href="{:U('Weixin/CustomMenu/add')}" target="mainContent"  class="btn">添加菜单</a>
  <a href="{:U('Weixin/Weixin/sendMenu')}" target="mainContent"  class="btn">生成自定义菜单</a>
  <form name="myform" class="J_ajaxForm" action="{:U('delete')}" method="post">
  <div class="table_list" style="margin-top:10px;">
  <table width="100%" cellspacing="0">
        <thead>
          <tr>
            <td width="10%"  align="center"><input type="checkbox" class="J_check_all" data-direction="x" data-checklist="J_check_x" onClick="selectall('tagid[]');">全选</td>
            <td width="10%">排序</td>
